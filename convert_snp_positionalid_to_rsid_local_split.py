...
def load_chrom_vcf(vcf_dir, chrom):
    ...
    filename = os.path.join(vcf_dir, f"homo_sapiens-chr{chrom}.vcf.gz")
...
def main():
    ...
    parser.add_argument("vcf_dir", help="Directory containing chromosome-specific VCF files (e.g., homo_sapiens-chr1.vcf.gz)")
